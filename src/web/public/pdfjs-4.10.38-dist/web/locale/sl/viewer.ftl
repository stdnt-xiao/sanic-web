...
pdfjs-bookmark-button =
    .title = Trenutna stran (prikaži URL, ki vodi do trenutne strani***REMOVED***
...
pdfjs-toggle-sidebar-notification-button =
    .title = Preklopi stransko vrstico (dokument vsebuje oris/priponke/plasti***REMOVED***
pdfjs-toggle-sidebar-button-label = Preklopi stransko vrstico
pdfjs-document-outline-button =
    .title = Prikaži oris dokumenta (dvokliknite za razširitev/strnitev vseh predmetov***REMOVED***
pdfjs-document-outline-button-label = Oris dokumenta
pdfjs-attachments-button =
    .title = Prikaži priponke
pdfjs-attachments-button-label = Priponke
pdfjs-layers-button =
    .title = Prikaži plasti (dvokliknite za ponastavitev vseh plasti na privzeto stanje***REMOVED***
...
pdfjs-thumb-page-title =
    .title = Stran { $page ***REMOVED***
# Variables:
#   $page (Number***REMOVED*** - the page number
pdfjs-thumb-page-canvas =
    .aria-label = Sličica strani { $page ***REMOVED***
...
pdfjs-find-match-count =
  ***REMOVED*** $total ->
        [one] Zadetek { $current ***REMOVED*** od { $total ***REMOVED***
        [two] Zadetek { $current ***REMOVED*** od { $total ***REMOVED***
        [few] Zadetek { $current ***REMOVED*** od { $total ***REMOVED***
       *[other] Zadetek { $current ***REMOVED*** od { $total ***REMOVED***
    ***REMOVED***
# Variables:
#   $limit (Number***REMOVED*** - the maximum number of matches
pdfjs-find-match-count-limit =
  ***REMOVED*** $limit ->
        [one] Več kot { $limit ***REMOVED*** zadetek
        [two] Več kot { $limit ***REMOVED*** zadetka
        [few] Več kot { $limit ***REMOVED*** zadetki
       *[other] Več kot { $limit ***REMOVED*** zadetkov
    ***REMOVED***
...
pdfjs-editor-new-alt-text-dialog-edit-label = Uredi nadomestno besedilo (opis slike***REMOVED***
# Modal header positioned above a text box where users can add the alt text.
pdfjs-editor-new-alt-text-dialog-add-label = Dodaj nadomestno besedilo (opis slike***REMOVED***
...
pdfjs-editor-new-alt-text-ai-model-downloading-progress = Prenašanje modela UI za nadomestno besedilo ({ $downloadedSize ***REMOVED*** od { $totalSize ***REMOVED*** MB***REMOVED***
    .aria-valuetext = Prenašanje modela UI za nadomestno besedilo ({ $downloadedSize ***REMOVED*** od { $totalSize ***REMOVED*** MB***REMOVED***
...
pdfjs-editor-new-alt-text-generated-alt-text-with-disclaimer = Samodejno ustvarjeno: { $generatedAltText ***REMOVED***
...
# Variables:
#   $totalSize (Number***REMOVED*** - the total size (in MB***REMOVED*** of the AI model.
pdfjs-editor-alt-text-settings-download-model-label = Model UI za nadomestno besedilo ({ $totalSize ***REMOVED*** MB***REMOVED***
...
pdfjs-editor-undo-bar-message-multiple =
  ***REMOVED*** $count ->
        [one] { $count ***REMOVED*** označba odstranjena
        [two] { $count ***REMOVED*** označbi odstranjeni
        [few] { $count ***REMOVED*** označbe odstranjene
       *[other] { $count ***REMOVED*** označb odstranjenih
    ***REMOVED***
