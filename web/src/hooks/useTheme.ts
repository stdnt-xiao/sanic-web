...
import { computed ***REMOVED*** from 'vue'
...
function lightenDarkenColor(col, amt***REMOVED*** {
  ...
  ***REMOVED***
  ...
  const num = parseInt(col, 16***REMOVED***

  let r = (num >> 16***REMOVED*** + amt

  if (r > 255***REMOVED*** r = 255
  else if (r < 0***REMOVED*** r = 0

  let b = ((num >> 8***REMOVED*** & 0x00FF***REMOVED*** + amt

  if (b > 255***REMOVED*** b = 255
  else if (b < 0***REMOVED*** b = 0

  let g = (num & 0x0000FF***REMOVED*** + amt

  if (g > 255***REMOVED*** g = 255
  else if (g < 0***REMOVED*** g = 0
...
function getComplementaryColor(hex***REMOVED*** {
  ...
  const r = parseInt(hex.substring(0, 2***REMOVED***, 16***REMOVED***
  const g = parseInt(hex.substring(2, 4***REMOVED***, 16***REMOVED***
  const b = parseInt(hex.substring(4, 6***REMOVED***, 16***REMOVED***
