...
pdfjs-of-pages = e nder { $pagesCount ***REMOVED***
# Variables:
...
pdfjs-document-properties-kb = { $size_kb ***REMOVED*** KB ({ $size_b ***REMOVED*** bite***REMOVED***
# Variables:
#   $size_mb (Number***REMOVED*** - the PDF file size in megabytes
#   $size_b (Number***REMOVED*** - the PDF file size in bytes
pdfjs-document-properties-mb = { $size_mb ***REMOVED*** MB ({ $size_b ***REMOVED*** bite***REMOVED***
...
pdfjs-document-outline-button =
    .title = Hollu Ƴiyal Fiilannde (dobdobo ngam wertude/taggude teme fof***REMOVED***
...
pdfjs-thumb-page-title =
    .title = Hello { $page ***REMOVED***
# Variables:
#   $page (Number***REMOVED*** - the page number
pdfjs-thumb-page-canvas =
    .aria-label = Dooɓre Hello { $page ***REMOVED***
