...
pdfjs-of-pages = összesen: { $pagesCount ***REMOVED***
# Variables:
...
pdfjs-bookmark-button =
    .title = Jelenlegi oldal (webcím megtekintése a jelenlegi oldalról***REMOVED***
...
pdfjs-document-properties-size-kb = { NUMBER($kb, maximumSignificantDigits: 3***REMOVED*** ***REMOVED*** kB ({ $b ***REMOVED*** bájt***REMOVED***
# Variables:
#   $mb (Number***REMOVED*** - the PDF file size in megabytes
#   $b (Number***REMOVED*** - the PDF file size in bytes
pdfjs-document-properties-size-mb = { NUMBER($mb, maximumSignificantDigits: 3***REMOVED*** ***REMOVED*** MB ({ $b ***REMOVED*** bájt***REMOVED***
# Variables:
#   $size_kb (Number***REMOVED*** - the PDF file size in kilobytes
#   $size_b (Number***REMOVED*** - the PDF file size in bytes
pdfjs-document-properties-kb = { $size_kb ***REMOVED*** KB ({ $size_b ***REMOVED*** bájt***REMOVED***
# Variables:
#   $size_mb (Number***REMOVED*** - the PDF file size in megabytes
#   $size_b (Number***REMOVED*** - the PDF file size in bytes
pdfjs-document-properties-mb = { $size_mb ***REMOVED*** MB ({ $size_b ***REMOVED*** bájt***REMOVED***
...
pdfjs-toggle-sidebar-notification-button =
    .title = Oldalsáv be/ki (a dokumentum vázlatot/mellékleteket/rétegeket tartalmaz***REMOVED***
pdfjs-toggle-sidebar-button-label = Oldalsáv be/ki
pdfjs-document-outline-button =
    .title = Dokumentum megjelenítése online (dupla kattintás minden elem kinyitásához/összecsukásához***REMOVED***
...
pdfjs-layers-button =
    .title = Rétegek megjelenítése (dupla kattintás az összes réteg alapértelmezett állapotra visszaállításához***REMOVED***
...
pdfjs-thumb-page-title =
    .title = { $page ***REMOVED***. oldal
# Variables:
#   $page (Number***REMOVED*** - the page number
pdfjs-thumb-page-canvas =
    .aria-label = { $page ***REMOVED***. oldal bélyegképe
...
pdfjs-find-match-count =
  ***REMOVED*** $total ->
        [one] { $current ***REMOVED*** / { $total ***REMOVED*** találat
       *[other] { $current ***REMOVED*** / { $total ***REMOVED*** találat
    ***REMOVED***
# Variables:
#   $limit (Number***REMOVED*** - the maximum number of matches
pdfjs-find-match-count-limit =
  ***REMOVED*** $limit ->
        [one] Több mint { $limit ***REMOVED*** találat
       *[other] Több mint { $limit ***REMOVED*** találat
    ***REMOVED***
...
pdfjs-editor-new-alt-text-dialog-edit-label = Alternatív szöveg szerkesztése (képleírás***REMOVED***
# Modal header positioned above a text box where users can add the alt text.
pdfjs-editor-new-alt-text-dialog-add-label = Alternatív szöveg hozzáadása (képleírás***REMOVED***
...
pdfjs-editor-new-alt-text-ai-model-downloading-progress = Alternatív szöveg MI modell letöltése ({ $downloadedSize ***REMOVED*** / { $totalSize ***REMOVED*** MB***REMOVED***
    .aria-valuetext = Alternatív szöveg MI modell letöltése ({ $downloadedSize ***REMOVED*** / { $totalSize ***REMOVED*** MB***REMOVED***
...
pdfjs-editor-new-alt-text-generated-alt-text-with-disclaimer = Automatikusan létrehozva: { $generatedAltText ***REMOVED***
...
# Variables:
#   $totalSize (Number***REMOVED*** - the total size (in MB***REMOVED*** of the AI model.
pdfjs-editor-alt-text-settings-download-model-label = Alternatív szöveg MI modellje ({ $totalSize ***REMOVED*** MB***REMOVED***
...
pdfjs-editor-undo-bar-message-multiple =
  ***REMOVED*** $count ->
        [one] { $count ***REMOVED*** kommentár eltávolítva
       *[other] { $count ***REMOVED*** kommentár eltávolítva
    ***REMOVED***
