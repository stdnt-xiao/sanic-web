...
pdfjs-bookmark-button =
    .title = Geçerli sayfa (geçerli sayfanın adresini görüntüle***REMOVED***
...
pdfjs-document-properties-size-kb = { NUMBER($kb, maximumSignificantDigits: 3***REMOVED*** ***REMOVED*** KB ({ $b ***REMOVED*** bayt***REMOVED***
# Variables:
#   $mb (Number***REMOVED*** - the PDF file size in megabytes
#   $b (Number***REMOVED*** - the PDF file size in bytes
pdfjs-document-properties-size-mb = { NUMBER($mb, maximumSignificantDigits: 3***REMOVED*** ***REMOVED*** MB ({ $b ***REMOVED*** bayt***REMOVED***
# Variables:
...
pdfjs-toggle-sidebar-notification-button =
    .title = Kenar çubuğunu aç/kapat (Belge ana hat/ekler/katmanlar içeriyor***REMOVED***
pdfjs-toggle-sidebar-button-label = Kenar çubuğunu aç/kapat
pdfjs-document-outline-button =
    .title = Belge ana hatlarını göster (Tüm öğeleri genişletmek/daraltmak için çift tıklayın***REMOVED***
pdfjs-document-outline-button-label = Belge ana hatları
pdfjs-attachments-button =
    .title = Ekleri göster
pdfjs-attachments-button-label = Ekler
pdfjs-layers-button =
    .title = Katmanları göster (tüm katmanları varsayılan duruma sıfırlamak için çift tıklayın***REMOVED***
...
pdfjs-thumb-page-title =
    .title = Sayfa { $page ***REMOVED***
# Variables:
#   $page (Number***REMOVED*** - the page number
pdfjs-thumb-page-canvas =
    .aria-label = { $page ***REMOVED***. sayfanın küçük hâli
...
pdfjs-find-match-count =
  ***REMOVED*** $total ->
        [one] { $total ***REMOVED*** eşleşmeden { $current ***REMOVED***. eşleşme
       *[other] { $total ***REMOVED*** eşleşmeden { $current ***REMOVED***. eşleşme
    ***REMOVED***
# Variables:
#   $limit (Number***REMOVED*** - the maximum number of matches
pdfjs-find-match-count-limit =
  ***REMOVED*** $limit ->
        [one] { $limit ***REMOVED*** eşleşmeden fazla
       *[other] { $limit ***REMOVED*** eşleşmeden fazla
    ***REMOVED***
...
pdfjs-editor-new-alt-text-dialog-edit-label = Alt metni düzenle (resim açıklaması***REMOVED***
# Modal header positioned above a text box where users can add the alt text.
pdfjs-editor-new-alt-text-dialog-add-label = Alt metin ekle (resim açıklaması***REMOVED***
...
pdfjs-editor-new-alt-text-ai-model-downloading-progress = Alt metin yapay zekâ modeli indiriliyor ({ $downloadedSize ***REMOVED*** / { $totalSize ***REMOVED*** MB***REMOVED***
    .aria-valuetext = Alt metin yapay zekâ modeli indiriliyor ({ $downloadedSize ***REMOVED*** / { $totalSize ***REMOVED*** MB***REMOVED***
...
pdfjs-editor-new-alt-text-generated-alt-text-with-disclaimer = Otomatik olarak oluşturuldu: { $generatedAltText ***REMOVED***
...
# Variables:
#   $totalSize (Number***REMOVED*** - the total size (in MB***REMOVED*** of the AI model.
pdfjs-editor-alt-text-settings-download-model-label = Alt metin yapay zekâ modeli ({ $totalSize ***REMOVED*** MB***REMOVED***
...
pdfjs-editor-undo-bar-message-multiple =
  ***REMOVED*** $count ->
        [one] { $count ***REMOVED*** ek açıklama silindi
       *[other] { $count ***REMOVED*** ek açıklama silindi
    ***REMOVED***
