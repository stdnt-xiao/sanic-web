...
pdfjs-bookmark-button =
    .title = Aktuell sida (Visa URL från aktuell sida***REMOVED***
...
pdfjs-toggle-sidebar-notification-button =
    .title = Växla sidofält (dokumentet innehåller dokumentstruktur/bilagor/lager***REMOVED***
pdfjs-toggle-sidebar-button-label = Visa/dölj sidofält
pdfjs-document-outline-button =
    .title = Visa dokumentdisposition (dubbelklicka för att expandera/komprimera alla objekt***REMOVED***
pdfjs-document-outline-button-label = Dokumentöversikt
pdfjs-attachments-button =
    .title = Visa Bilagor
pdfjs-attachments-button-label = Bilagor
pdfjs-layers-button =
    .title = Visa lager (dubbelklicka för att återställa alla lager till standardläge***REMOVED***
...
pdfjs-thumb-page-title =
    .title = Sida { $page ***REMOVED***
# Variables:
#   $page (Number***REMOVED*** - the page number
pdfjs-thumb-page-canvas =
    .aria-label = Miniatyr av sida { $page ***REMOVED***
...
pdfjs-find-match-count =
  ***REMOVED*** $total ->
        [one] { $current ***REMOVED*** av { $total ***REMOVED*** match
       *[other] { $current ***REMOVED*** av { $total ***REMOVED*** matchningar
    ***REMOVED***
# Variables:
#   $limit (Number***REMOVED*** - the maximum number of matches
pdfjs-find-match-count-limit =
  ***REMOVED*** $limit ->
        [one] Mer än { $limit ***REMOVED*** matchning
       *[other] Fler än { $limit ***REMOVED*** matchningar
    ***REMOVED***
...
pdfjs-editor-alt-text-dialog-description = Alt text (alternativ text***REMOVED*** hjälper till när människor inte kan se bilden eller när den inte laddas.
...
pdfjs-editor-new-alt-text-dialog-edit-label = Redigera alternativ text (bildbeskrivning***REMOVED***
# Modal header positioned above a text box where users can add the alt text.
pdfjs-editor-new-alt-text-dialog-add-label = Lägg till alternativ text (bildbeskrivning***REMOVED***
...
pdfjs-editor-new-alt-text-ai-model-downloading-progress = Hämtar AI-modell med alternativ text ({ $downloadedSize ***REMOVED*** av { $totalSize ***REMOVED*** MB***REMOVED***
    .aria-valuetext = Hämtar AI-modell med alternativ text ({ $downloadedSize ***REMOVED*** av { $totalSize ***REMOVED*** MB***REMOVED***
...
pdfjs-editor-new-alt-text-generated-alt-text-with-disclaimer = Skapas automatiskt: { $generatedAltText ***REMOVED***
...
# Variables:
#   $totalSize (Number***REMOVED*** - the total size (in MB***REMOVED*** of the AI model.
pdfjs-editor-alt-text-settings-download-model-label = AI-modell för alternativ text ({ $totalSize ***REMOVED*** MB***REMOVED***
...
pdfjs-editor-undo-bar-message-multiple =
  ***REMOVED*** $count ->
        [one] { $count ***REMOVED*** anteckning har tagits bort
       *[other] { $count ***REMOVED*** anteckningar har tagits bort
    ***REMOVED***
