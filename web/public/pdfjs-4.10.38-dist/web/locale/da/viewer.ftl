...
pdfjs-bookmark-button =
    .title = Aktuel side (vis URL fra den aktuelle side***REMOVED***
...
pdfjs-toggle-sidebar-notification-button =
    .title = Slå sidepanel til eller fra (dokumentet indeholder disposition/vedhæftede filer/lag***REMOVED***
pdfjs-toggle-sidebar-button-label = Slå sidepanel til eller fra
pdfjs-document-outline-button =
    .title = Vis dokumentets disposition (dobbeltklik for at udvide/sammenfolde alle elementer***REMOVED***
...
pdfjs-layers-button =
    .title = Vis lag (dobbeltklik for at nulstille alle lag til standard-tilstanden***REMOVED***
...
pdfjs-thumb-page-canvas =
    .aria-label = Miniature af side { $page ***REMOVED***
...
pdfjs-find-match-count =
  ***REMOVED*** $total ->
        [one] { $current ***REMOVED*** af { $total ***REMOVED*** forekomst
       *[other] { $current ***REMOVED*** af { $total ***REMOVED*** forekomster
    ***REMOVED***
# Variables:
#   $limit (Number***REMOVED*** - the maximum number of matches
pdfjs-find-match-count-limit =
  ***REMOVED*** $limit ->
        [one] Mere end { $limit ***REMOVED*** forekomst
       *[other] Mere end { $limit ***REMOVED*** forekomster
    ***REMOVED***
...
pdfjs-editor-new-alt-text-dialog-edit-label = Rediger alternativ tekst (billedbeskrivelse***REMOVED***
# Modal header positioned above a text box where users can add the alt text.
pdfjs-editor-new-alt-text-dialog-add-label = Tilføj alternativ tekst (billedbeskrivelse***REMOVED***
...
pdfjs-editor-new-alt-text-ai-model-downloading-progress = Henter alternativ tekst AI-model ({ $downloadedSize ***REMOVED*** af { $totalSize ***REMOVED*** MB***REMOVED***
    .aria-valuetext = Henter alternativ tekst AI-model ({ $downloadedSize ***REMOVED*** af { $totalSize ***REMOVED*** MB***REMOVED***
...
pdfjs-editor-new-alt-text-generated-alt-text-with-disclaimer = Oprettet automatisk: { $generatedAltText ***REMOVED***
...
# Variables:
#   $totalSize (Number***REMOVED*** - the total size (in MB***REMOVED*** of the AI model.
pdfjs-editor-alt-text-settings-download-model-label = AI-model til at oprette alternative tekster ({ $totalSize ***REMOVED*** MB***REMOVED***
...
pdfjs-editor-undo-bar-message-multiple =
  ***REMOVED*** $count ->
        [one] { $count ***REMOVED*** kommentar fjernet
       *[other] { $count ***REMOVED*** kommentarer fjernet
    ***REMOVED***
