...
pdfjs-document-outline-button =
    .title = Mostrar esquema del documento (doble clic para expandir/colapsar todos los ítems***REMOVED***
...
pdfjs-thumb-page-canvas =
    .aria-label = Miniatura de página { $page ***REMOVED***
...
pdfjs-editor-new-alt-text-ai-model-downloading-progress = Descargando modelo de IA de texto alternativo ({ $downloadedSize ***REMOVED*** de { $totalSize ***REMOVED*** MB***REMOVED***
    .aria-valuetext = Descargando modelo de IA de texto alternativo ({ $downloadedSize ***REMOVED*** de { $totalSize ***REMOVED*** MB***REMOVED***
