...
pdfjs-of-pages = { $pagesCount ***REMOVED*** gui
# Variables:
...
pdfjs-bookmark-button =
    .title = Kuatiarogue ag̃agua (Ehecha URL kuatiarogue ag̃agua***REMOVED***
...
pdfjs-toggle-sidebar-notification-button =
    .title = Embojopyru tenda ykegua (kuatia oguereko kuaakaha/moirũha/ñuãha***REMOVED***
pdfjs-toggle-sidebar-button-label = Tenda yke moambue
pdfjs-document-outline-button =
    .title = Ehechauka kuatia rape (eikutu mokõi jey embotuicha/emomichĩ hag̃ua opavavete mba’eporu***REMOVED***
pdfjs-document-outline-button-label = Kuatia apopyre
pdfjs-attachments-button =
    .title = Moirũha jehechauka
pdfjs-attachments-button-label = Moirũha
pdfjs-layers-button =
    .title = Ehechauka ñuãha (eikutu jo’a emomba’apo hag̃ua opaite ñuãha tekoypýpe***REMOVED***
...
pdfjs-thumb-page-title =
    .title = Kuatiarogue { $page ***REMOVED***
# Variables:
#   $page (Number***REMOVED*** - the page number
pdfjs-thumb-page-canvas =
    .aria-label = Kuatiarogue mba’emirĩ { $page ***REMOVED***
...
pdfjs-find-match-count =
  ***REMOVED*** $total ->
        [one] { $current ***REMOVED*** ha { $total ***REMOVED*** ojueheguáva
       *[other] { $current ***REMOVED*** ha { $total ***REMOVED*** ojueheguáva
    ***REMOVED***
# Variables:
#   $limit (Number***REMOVED*** - the maximum number of matches
pdfjs-find-match-count-limit =
  ***REMOVED*** $limit ->
        [one] Hetave { $limit ***REMOVED*** ojueheguáva
       *[other] Hetave { $limit ***REMOVED*** ojueheguáva
    ***REMOVED***
...
#   $page (Number***REMOVED*** - the page number
pdfjs-page-landmark =
    .aria-label = Kuatiarogue { $page ***REMOVED***
...
pdfjs-editor-alt-text-dialog-description = Moñe’ẽrã ykepegua (moñe’ẽrã ykepegua***REMOVED*** nepytyvõ nderehecháiramo ta’ãnga térã nahenyhẽiramo.
...
pdfjs-editor-new-alt-text-dialog-edit-label = Embosako’i moñe’ẽrã mokõiha (ta’ãngáre ñeñe’ẽ***REMOVED***
# Modal header positioned above a text box where users can add the alt text.
pdfjs-editor-new-alt-text-dialog-add-label = Embojuaju moñe’ẽrã mokõiha (ta’ãngáre ñeñe’ẽ***REMOVED***
...
pdfjs-editor-new-alt-text-ai-model-downloading-progress = Emboguejyhína IA moñe’ẽrã mokõiháva ({ $downloadedSize ***REMOVED*** { $totalSize ***REMOVED*** MB***REMOVED*** mba’e
    .aria-valuetext = Emboguejyhína IA moñe’ẽrã mokõiháva ({ $downloadedSize ***REMOVED*** { $totalSize ***REMOVED*** MB***REMOVED*** mba’e
...
pdfjs-editor-new-alt-text-generated-alt-text-with-disclaimer = Heñóiva ijeheguiete: { $generatedAltText ***REMOVED***
...
# Variables:
#   $totalSize (Number***REMOVED*** - the total size (in MB***REMOVED*** of the AI model.
pdfjs-editor-alt-text-settings-download-model-label = Peteĩva IA moñe’ẽrã mokõiha ({ $totalSize ***REMOVED*** MB***REMOVED***
...
pdfjs-editor-undo-bar-message-multiple =
  ***REMOVED*** $count ->
        [one] { $count ***REMOVED*** jehaikue mboguepyre
       *[other] { $count ***REMOVED*** jehaikue mboguepyre
    ***REMOVED***
