...
pdfjs-toggle-sidebar-notification-button =
    .title = Cambiar barra lateral (índice de contenidos del documento/adjuntos/capas***REMOVED***
...
pdfjs-find-match-count =
  ***REMOVED*** $total ->
        [one] Coincidencia { $current ***REMOVED*** de { $total ***REMOVED***
       *[other] Coincidencia { $current ***REMOVED*** de { $total ***REMOVED***
    ***REMOVED***
# Variables:
...
pdfjs-editor-alt-text-dialog-description = El texto alternativo (alt text***REMOVED*** ayuda cuando las personas no pueden ver la imagen o cuando no se carga.
