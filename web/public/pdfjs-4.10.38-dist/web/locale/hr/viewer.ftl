...
pdfjs-bookmark-button =
    .title = Trenutna stranica (pogledajte URL s trenutne stranice***REMOVED***
...
pdfjs-document-properties-size-kb = { NUMBER($kb, maximumSignificantDigits: 3***REMOVED*** ***REMOVED*** KB ({ $b ***REMOVED*** bajtova***REMOVED***
# Variables:
#   $mb (Number***REMOVED*** - the PDF file size in megabytes
#   $b (Number***REMOVED*** - the PDF file size in bytes
pdfjs-document-properties-size-mb = { NUMBER($mb, maximumSignificantDigits: 3***REMOVED*** ***REMOVED*** MB ({ $b ***REMOVED*** bajtova***REMOVED***
# Variables:
#   $size_kb (Number***REMOVED*** - the PDF file size in kilobytes
#   $size_b (Number***REMOVED*** - the PDF file size in bytes
pdfjs-document-properties-kb = { $size_kb ***REMOVED*** KB ({ $size_b ***REMOVED*** bajtova***REMOVED***
# Variables:
#   $size_mb (Number***REMOVED*** - the PDF file size in megabytes
#   $size_b (Number***REMOVED*** - the PDF file size in bytes
pdfjs-document-properties-mb = { $size_mb ***REMOVED*** MB ({ $size_b ***REMOVED*** bajtova***REMOVED***
...
pdfjs-toggle-sidebar-notification-button =
    .title = Prikazivanje i sklanjanje bočne trake (dokument sadrži strukturu/privitke/slojeve***REMOVED***
pdfjs-toggle-sidebar-button-label = Prikaži/sakrij bočnu traku
pdfjs-document-outline-button =
    .title = Prikaži strukturu dokumenta (dvostruki klik za rasklapanje/sklapanje svih stavki***REMOVED***
pdfjs-document-outline-button-label = Struktura dokumenta
pdfjs-attachments-button =
    .title = Prikaži privitke
pdfjs-attachments-button-label = Privitci
pdfjs-layers-button =
    .title = Prikaži slojeve (dvoklik za vraćanje svih slojeva u standardno stanje***REMOVED***
...
pdfjs-thumb-page-title =
    .title = Stranica { $page ***REMOVED***
# Variables:
#   $page (Number***REMOVED*** - the page number
pdfjs-thumb-page-canvas =
    .aria-label = Minijatura stranice { $page ***REMOVED***
...
pdfjs-find-match-count =
  ***REMOVED*** $total ->
        [one] { $current ***REMOVED*** od { $total ***REMOVED*** rezultata
        [few] { $current ***REMOVED*** od { $total ***REMOVED*** rezultata
       *[other] { $current ***REMOVED*** od { $total ***REMOVED*** rezultata
    ***REMOVED***
# Variables:
#   $limit (Number***REMOVED*** - the maximum number of matches
pdfjs-find-match-count-limit =
  ***REMOVED*** $limit ->
        [one] Više od { $limit ***REMOVED*** rezultat
        [few] Više od { $limit ***REMOVED*** rezultata
       *[other] Više od { $limit ***REMOVED*** rezultata
    ***REMOVED***
...
#   $page (Number***REMOVED*** - the page number
pdfjs-page-landmark =
    .aria-label = Stranica { $page ***REMOVED***
...
pdfjs-editor-new-alt-text-ai-model-downloading-progress = Preuzimanje alternativnog teksta UI modela ({ $downloadedSize ***REMOVED*** od { $totalSize ***REMOVED*** MB***REMOVED***
    .aria-valuetext = Preuzimanje alternativnog teksta UI modela ({ $downloadedSize ***REMOVED*** od { $totalSize ***REMOVED*** MB***REMOVED***
...
pdfjs-editor-new-alt-text-generated-alt-text-with-disclaimer = Stvoreno automatski: { $generatedAltText ***REMOVED***
...
# Variables:
#   $totalSize (Number***REMOVED*** - the total size (in MB***REMOVED*** of the AI model.
pdfjs-editor-alt-text-settings-download-model-label = Alternativni tekst UI modela ({ $totalSize ***REMOVED*** MB***REMOVED***
