...
pdfjs-of-pages = daripada { $pagesCount ***REMOVED***
# Variables:
#   $pageNumber (Number***REMOVED*** - the currently visible page
#   $pagesCount (Number***REMOVED*** - the total number of pages in the document
pdfjs-page-of-pages = ({ $pageNumber ***REMOVED*** daripada { $pagesCount ***REMOVED******REMOVED***
...
pdfjs-document-properties-kb = { $size_kb ***REMOVED*** KB ({ $size_b ***REMOVED*** bait***REMOVED***
# Variables:
#   $size_mb (Number***REMOVED*** - the PDF file size in megabytes
#   $size_b (Number***REMOVED*** - the PDF file size in bytes
pdfjs-document-properties-mb = { $size_mb ***REMOVED*** MB ({ $size_b ***REMOVED*** bait***REMOVED***
...
pdfjs-document-outline-button =
    .title = Papar Rangka Dokumen (klik-dua-kali untuk kembangkan/kolaps semua item***REMOVED***
...
pdfjs-thumb-page-title =
    .title = Halaman { $page ***REMOVED***
# Variables:
#   $page (Number***REMOVED*** - the page number
pdfjs-thumb-page-canvas =
    .aria-label = Halaman Imej kecil { $page ***REMOVED***
