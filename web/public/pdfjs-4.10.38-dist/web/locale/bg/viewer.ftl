...
pdfjs-of-pages = от { $pagesCount ***REMOVED***
# Variables:
#   $pageNumber (Number***REMOVED*** - the currently visible page
#   $pagesCount (Number***REMOVED*** - the total number of pages in the document
pdfjs-page-of-pages = ({ $pageNumber ***REMOVED*** от { $pagesCount ***REMOVED******REMOVED***
...
pdfjs-bookmark-button =
    .title = Текуща страница (преглед на адреса на страницата***REMOVED***
...
pdfjs-document-properties-size-kb = { NUMBER($kb, maximumSignificantDigits: 3***REMOVED*** ***REMOVED*** КБ ({ $b ***REMOVED*** байта***REMOVED***
# Variables:
#   $mb (Number***REMOVED*** - the PDF file size in megabytes
#   $b (Number***REMOVED*** - the PDF file size in bytes
pdfjs-document-properties-size-mb = { NUMBER($mb, maximumSignificantDigits: 3***REMOVED*** ***REMOVED*** МБ ({ $b ***REMOVED*** байта***REMOVED***
# Variables:
#   $size_kb (Number***REMOVED*** - the PDF file size in kilobytes
#   $size_b (Number***REMOVED*** - the PDF file size in bytes
pdfjs-document-properties-kb = { $size_kb ***REMOVED*** КБ ({ $size_b ***REMOVED*** байта***REMOVED***
# Variables:
#   $size_mb (Number***REMOVED*** - the PDF file size in megabytes
#   $size_b (Number***REMOVED*** - the PDF file size in bytes
pdfjs-document-properties-mb = { $size_mb ***REMOVED*** МБ ({ $size_b ***REMOVED*** байта***REMOVED***
...
pdfjs-toggle-sidebar-notification-button =
    .title = Превключване на страничната лента (документът има структура/прикачени файлове/слоеве***REMOVED***
pdfjs-toggle-sidebar-button-label = Превключване на страничната лента
pdfjs-document-outline-button =
    .title = Показване на структурата на документа (двукратно щракване за свиване/разгъване на всичко***REMOVED***
...
pdfjs-layers-button =
    .title = Показване на слоевете (двукратно щракване за възстановяване на всички слоеве към състоянието по подразбиране***REMOVED***
...
pdfjs-thumb-page-canvas =
    .aria-label = Миниатюра на страница { $page ***REMOVED***
...
pdfjs-find-match-count =
  ***REMOVED*** $total ->
        [one] { $current ***REMOVED*** от { $total ***REMOVED*** съвпадение
       *[other] { $current ***REMOVED*** от { $total ***REMOVED*** съвпадения
    ***REMOVED***
# Variables:
#   $limit (Number***REMOVED*** - the maximum number of matches
pdfjs-find-match-count-limit =
  ***REMOVED*** $limit ->
        [one] Повече от { $limit ***REMOVED*** съвпадение
       *[other] Повече от { $limit ***REMOVED*** съвпадения
    ***REMOVED***
