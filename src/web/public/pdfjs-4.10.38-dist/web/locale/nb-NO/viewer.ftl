...
pdfjs-bookmark-button =
    .title = Gjeldende side (se URL fra gjeldende side***REMOVED***
...
pdfjs-toggle-sidebar-notification-button =
    .title = Vis/gjem sidestolpe (dokumentet inneholder oversikt/vedlegg/lag***REMOVED***
pdfjs-toggle-sidebar-button-label = Slå av/på sidestolpe
pdfjs-document-outline-button =
    .title = Vis dokumentdisposisjonen (dobbeltklikk for å utvide/skjule alle elementer***REMOVED***
...
pdfjs-find-match-count-limit =
  ***REMOVED*** $limit ->
        [one] Mer enn { $limit ***REMOVED*** treff
       *[other] Mer enn { $limit ***REMOVED*** treff
    ***REMOVED***
...
pdfjs-editor-alt-text-dialog-description = Alt-tekst (alternativ tekst***REMOVED*** hjelper når folk ikke kan se bildet eller når det ikke lastes inn.
...
pdfjs-editor-new-alt-text-dialog-edit-label = Rediger alternativ tekst (bildebeskrivelse***REMOVED***
# Modal header positioned above a text box where users can add the alt text.
pdfjs-editor-new-alt-text-dialog-add-label = Legg til alternativ tekst (bildebeskrivelse***REMOVED***
...
pdfjs-editor-new-alt-text-ai-model-downloading-progress = Laster ned alternativ tekst AI-modell ({ $downloadedSize ***REMOVED*** av { $totalSize ***REMOVED*** MB***REMOVED***
    .aria-valuetext = Laster ned alternativ tekst AI-modell ({ $downloadedSize ***REMOVED*** av { $totalSize ***REMOVED*** MB***REMOVED***
...
pdfjs-editor-new-alt-text-generated-alt-text-with-disclaimer = Opprettet automatisk: { $generatedAltText ***REMOVED***
...
# Variables:
#   $totalSize (Number***REMOVED*** - the total size (in MB***REMOVED*** of the AI model.
pdfjs-editor-alt-text-settings-download-model-label = Alternativ tekst AI-modell ({ $totalSize ***REMOVED*** MB***REMOVED***
