...
pdfjs-of-pages = { $pagesCount ***REMOVED*** नि
# Variables:
#   $pageNumber (Number***REMOVED*** - the currently visible page
#   $pagesCount (Number***REMOVED*** - the total number of pages in the document
pdfjs-page-of-pages = ({ $pagesCount ***REMOVED*** नि { $pageNumber ***REMOVED******REMOVED***
...
pdfjs-document-properties-kb = { $size_kb ***REMOVED*** KB ({ $size_b ***REMOVED*** बाइट***REMOVED***
# Variables:
#   $size_mb (Number***REMOVED*** - the PDF file size in megabytes
#   $size_b (Number***REMOVED*** - the PDF file size in bytes
pdfjs-document-properties-mb = { $size_mb ***REMOVED*** MB ({ $size_b ***REMOVED*** बाइट***REMOVED***
...
pdfjs-thumb-page-title =
    .title = बिलाइ { $page ***REMOVED***
# Variables:
#   $page (Number***REMOVED*** - the page number
pdfjs-thumb-page-canvas =
    .aria-label = बिलाइ { $page ***REMOVED*** नि थामनेइल
...
pdfjs-text-annotation-type =
    .alt = [{ $type ***REMOVED*** सोदोब बेखेवनाय]
