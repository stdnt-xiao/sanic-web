...
pdfjs-bookmark-button =
    .title = Página atual (ver URL da página atual***REMOVED***
...
pdfjs-toggle-sidebar-notification-button =
    .title = Alternar barra lateral (o documento contém contornos/anexos/camadas***REMOVED***
pdfjs-toggle-sidebar-button-label = Alternar barra lateral
pdfjs-document-outline-button =
    .title = Mostrar esquema do documento (duplo clique para expandir/colapsar todos os itens***REMOVED***
pdfjs-document-outline-button-label = Esquema do documento
pdfjs-attachments-button =
    .title = Mostrar anexos
pdfjs-attachments-button-label = Anexos
pdfjs-layers-button =
    .title = Mostrar camadas (clique duas vezes para repor todas as camadas para o estado predefinido***REMOVED***
...
pdfjs-thumb-page-title =
    .title = Página { $page ***REMOVED***
# Variables:
#   $page (Number***REMOVED*** - the page number
pdfjs-thumb-page-canvas =
    .aria-label = Miniatura da página { $page ***REMOVED***
...
pdfjs-find-match-count =
  ***REMOVED*** $total ->
        [one] { $current ***REMOVED*** de { $total ***REMOVED*** correspondência
       *[other] { $current ***REMOVED*** de { $total ***REMOVED*** correspondências
    ***REMOVED***
# Variables:
#   $limit (Number***REMOVED*** - the maximum number of matches
pdfjs-find-match-count-limit =
  ***REMOVED*** $limit ->
        [one] Mais de { $limit ***REMOVED*** correspondência
       *[other] Mais de { $limit ***REMOVED*** correspondências
    ***REMOVED***
...
#   $page (Number***REMOVED*** - the page number
pdfjs-page-landmark =
    .aria-label = Página { $page ***REMOVED***
...
pdfjs-editor-alt-text-dialog-description = O texto alternativo (texto alternativo***REMOVED*** ajuda quando as pessoas não conseguem ver a imagem ou quando a mesma não é carregada.
...
pdfjs-editor-new-alt-text-dialog-edit-label = Editar texto alternativo (descrição da imagem***REMOVED***
# Modal header positioned above a text box where users can add the alt text.
pdfjs-editor-new-alt-text-dialog-add-label = Adicionar texto alternativo (descrição da imagem***REMOVED***
...
pdfjs-editor-new-alt-text-ai-model-downloading-progress = A transferir o modelo de IA de texto alternativo ({ $downloadedSize ***REMOVED*** de { $totalSize ***REMOVED*** MB***REMOVED***
    .aria-valuetext = A transferir o modelo de IA de texto alternativo ({ $downloadedSize ***REMOVED*** de { $totalSize ***REMOVED*** MB***REMOVED***
...
pdfjs-editor-new-alt-text-generated-alt-text-with-disclaimer = Criado automaticamente: { $generatedAltText ***REMOVED***
...
# Variables:
#   $totalSize (Number***REMOVED*** - the total size (in MB***REMOVED*** of the AI model.
pdfjs-editor-alt-text-settings-download-model-label = Modelo de IA de texto alternativo ({ $totalSize ***REMOVED*** MB***REMOVED***
...
pdfjs-editor-undo-bar-message-multiple =
  ***REMOVED*** $count ->
        [one] { $count ***REMOVED*** anotação removida
       *[other] { $count ***REMOVED*** anotações removidas
    ***REMOVED***
