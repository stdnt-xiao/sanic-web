...
pdfjs-of-pages = da { $pagesCount ***REMOVED***
# Variables:
#   $pageNumber (Number***REMOVED*** - the currently visible page
#   $pagesCount (Number***REMOVED*** - the total number of pages in the document
pdfjs-page-of-pages = ({ $pageNumber ***REMOVED*** da { $pagesCount ***REMOVED******REMOVED***
...
pdfjs-bookmark-button =
    .title = Pagina actuala (mussar l'URL da la pagina actuala***REMOVED***
...
pdfjs-toggle-sidebar-notification-button =
    .title = Activar/deactivar la trav laterala (il document cuntegna structura dal document/agiuntas/nivels***REMOVED***
pdfjs-toggle-sidebar-button-label = Activar/deactivar la trav laterala
pdfjs-document-outline-button =
    .title = Mussar la structura dal document (cliccar duas giadas per extender/cumprimer tut ils elements***REMOVED***
...
pdfjs-layers-button =
    .title = Mussar ils nivels (cliccar dubel per restaurar il stadi da standard da tut ils nivels***REMOVED***
...
pdfjs-thumb-page-canvas =
    .aria-label = Miniatura da la pagina { $page ***REMOVED***
...
pdfjs-find-match-count =
  ***REMOVED*** $total ->
        [one] { $current ***REMOVED*** dad { $total ***REMOVED*** correspundenza
       *[other] { $current ***REMOVED*** da { $total ***REMOVED*** correspundenzas
    ***REMOVED***
# Variables:
#   $limit (Number***REMOVED*** - the maximum number of matches
pdfjs-find-match-count-limit =
  ***REMOVED*** $limit ->
        [one] Dapli che { $limit ***REMOVED*** correspundenza
       *[other] Dapli che { $limit ***REMOVED*** correspundenzas
    ***REMOVED***
...
pdfjs-text-annotation-type =
    .alt = [Annotaziun da { $type ***REMOVED***]
# Variables:
...
pdfjs-editor-alt-text-dialog-description = Il text alternativ (alt text***REMOVED*** gida en cas che persunas na vesan betg il maletg u sch'i na reussescha betg d'al chargiar.
...
pdfjs-editor-new-alt-text-dialog-edit-label = Modifitgar il text alternativ (descripziun dal maletg***REMOVED***
# Modal header positioned above a text box where users can add the alt text.
pdfjs-editor-new-alt-text-dialog-add-label = Agiuntar in text alternativ (descripziun dal maletg***REMOVED***
...
pdfjs-editor-new-alt-text-ai-model-downloading-progress = Telechargiar il model IA da text alternativ ({ $downloadedSize ***REMOVED*** da { $totalSize ***REMOVED*** MB***REMOVED***
    .aria-valuetext = Telechargiar il model IA da text alternativ ({ $downloadedSize ***REMOVED*** da { $totalSize ***REMOVED*** MB***REMOVED***
...
pdfjs-editor-new-alt-text-generated-alt-text-with-disclaimer = Creà automaticamain: { $generatedAltText ***REMOVED***
...
# Variables:
#   $totalSize (Number***REMOVED*** - the total size (in MB***REMOVED*** of the AI model.
pdfjs-editor-alt-text-settings-download-model-label = Model IA da text alternativ ({ $totalSize ***REMOVED*** MB***REMOVED***
...
pdfjs-editor-undo-bar-message-multiple =
  ***REMOVED*** $count ->
        [one] { $count ***REMOVED*** annotaziun allontanada
       *[other] { $count ***REMOVED*** annotaziuns allontanadas
    ***REMOVED***
