...
pdfjs-toggle-sidebar-notification-button =
    .title = Exibir/ocultar painel lateral (documento contém estrutura/anexos/camadas***REMOVED***
pdfjs-toggle-sidebar-button-label = Exibir/ocultar painel lateral
pdfjs-document-outline-button =
    .title = Mostrar estrutura do documento (duplo-clique expande/recolhe todos os itens***REMOVED***
pdfjs-document-outline-button-label = Estrutura do documento
pdfjs-attachments-button =
    .title = Mostrar anexos
pdfjs-attachments-button-label = Anexos
pdfjs-layers-button =
    .title = Mostrar camadas (duplo-clique redefine todas as camadas ao estado predefinido***REMOVED***
...
pdfjs-find-match-count =
  ***REMOVED*** $total ->
        [one] { $current ***REMOVED*** de { $total ***REMOVED*** ocorrência
       *[other] { $current ***REMOVED*** de { $total ***REMOVED*** ocorrências
    ***REMOVED***
# Variables:
#   $limit (Number***REMOVED*** - the maximum number of matches
pdfjs-find-match-count-limit =
  ***REMOVED*** $limit ->
        [one] Mais de { $limit ***REMOVED*** ocorrência
       *[other] Mais de { $limit ***REMOVED*** ocorrências
    ***REMOVED***
...
pdfjs-editor-new-alt-text-ai-model-downloading-progress = Baixando modelo de inteligência artificial de texto alternativo ({ $downloadedSize ***REMOVED*** de { $totalSize ***REMOVED*** MB***REMOVED***
    .aria-valuetext = Baixando modelo de inteligência artificial de texto alternativo ({ $downloadedSize ***REMOVED*** de { $totalSize ***REMOVED*** MB***REMOVED***
...
# Variables:
#   $totalSize (Number***REMOVED*** - the total size (in MB***REMOVED*** of the AI model.
pdfjs-editor-alt-text-settings-download-model-label = Modelo de inteligência artificial de texto alternativo ({ $totalSize ***REMOVED*** MB***REMOVED***
