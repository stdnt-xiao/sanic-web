...
const buttonLabel = computed((***REMOVED*** => {
    switch (props.qa_type***REMOVED*** {
        case 'DATABASE_QA':
            return '数据问答'
        case 'FILEDATA_QA':
            return '表格问答'
...
***REMOVED***
    <n-button
        ...
        style="
            ...
            font-size: 11px;
            color: #ffffff;
            background: linear-gradient(to right, #615ced, #615ced***REMOVED***;
        "
    >
      ...
      ***REMOVED***
        ...
        ***REMOVED***
      ***REMOVED***{ buttonLabel ***REMOVED******REMOVED***
    </n-button>
***REMOVED***
